...
from medical_agent_core import (
    MedicalDomain, DifficultyLevel, MedicalQuery, 
    RetrievedDocument, MedicalDifficultyClassifier
)
...
class DomainSpecificRetriever:
    ...
    def load_corpus(self):
        ...
        # Mock corpus - in practice, load from medical databases
        mock_corpus = self.create_mock_corpus()
        
        # Encode documents
        doc_texts = [doc['content'] for doc in mock_corpus]
